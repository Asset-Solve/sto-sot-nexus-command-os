...
- **SAP-native actionability (v1.3)**: Scope, Work Packages, Schedule, Materials, Control of Work and Execution Map now expose S/4-native user triggers for maintenance order creation, operations, components, component quantity changes, order status, DMS evidence, reservation quantity changes, goods issue/return, WCM preplan routing and SSAM/FSM dispatch. See `../../docs/integration/SAP_NATIVE_ACTIONABILITY_MAP.md`.
...
| SAP-native actionability tests | `tests/sap-actionability.test.ts` |
