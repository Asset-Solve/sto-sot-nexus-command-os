...
export const PROCESS_STAGES: ProcessStage[] = [
  ...
  { id: 'orders', num: 3, name: 'Order Association, E-Workpacks & Packages', route: '/work-packages', kickoffSteps: '7–8', phase: 'PLANNING', personas: ['maintenance_planner', 'work_package_owner'], objects: ['MaintenanceOrderProxy', 'MaintenanceOperationProxy', 'WorkPackage', 'ElectronicWorkpack', 'DocumentBundle'], exitCriteria: 'Every approved scope has SAP order/operations; WP360/e-workpack assembled; readiness 9/9' },
  { id: 'materials', num: 4, name: 'Materials, Tools & Procurement Readiness', route: '/materials', kickoffSteps: '9', phase: 'READINESS', personas: ['material_planner', 'procurement_user', 'warehouse_lead'], objects: ['MaterialDemand', 'ReservationProxy', 'StagingKit', 'ToolDemand', 'ExpeditingCase'], exitCriteria: 'No critical shortages; reservations posted to SAP; kits/tools staged' },
...
export const STATE_ACTIONS: StateAction[] = [
  ...
  { objectType: 'PermitRequirement', states: ['missing'], actionId: 'permit.request_preplan', prefill: { workPackageId: 'wpId', preplanType: 'permitType', requiredBy: 'requiredBy' }, hint: 'Request WCM/ePTW permit preplan package' },
  { objectType: 'IsolationPlan', states: ['draft'], actionId: 'permit.request_preplan', prefill: { workPackageId: 'wpId', preplanType: 'isolationType' }, hint: 'Route isolation preplan to WCM authority' },
