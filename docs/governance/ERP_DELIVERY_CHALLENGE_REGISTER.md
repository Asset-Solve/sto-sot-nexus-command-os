...
| CH-12 | Brittle point-to-point integration | Tightly coupled sync calls everywhere | Outage cascades on any change | Event-driven decoupling (SAP Integration Suite advanced event mesh / async), contract tests | 08, 14 | contract tests; async spec |
